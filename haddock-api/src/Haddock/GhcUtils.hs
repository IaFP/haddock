...
reparenTypePrec :: forall a. (
  ...
  WDT (XRec a (HsType a)),
  WDT (Anno (HsType a)),
  WDT (Anno [XRec a (HsType a)]),
  WDT (XRec a [XRec a (HsType a)]),
  WDT (Anno (HsTyVarBndr Specificity a)),
  WDT (XRec a (HsTyVarBndr Specificity a)),
  WDT (Anno (HsTyVarBndr () a)),
  WDT (XRec a (HsTyVarBndr () a)),
  WDT (Anno (ConDeclField a)),
  WDT (XRec a (ConDeclField a)),
  WDT (XParTy a),
  WDT (XConDeclField a),
  WDT (XRec a (FieldOcc a)),
  WDT (XBangTy a),
  WDT (XTupleTy a),
  WDT (XSumTy a),
  WDT (XListTy a),
  WDT (XRecTy a),
  WDT (XDocTy a),
  WDT (XExplicitListTy a),
  WDT (XExplicitTupleTy a),
  WDT (XKindSig a),
  WDT (XIParamTy a),
  WDT (XRec a HsIPName),
  WDT (XForAllTy a),
...
reparenSigType :: forall a. (
  ...
  WDT (XUserTyVar a),
  WDT (XKindedTyVar a),  
  WDT (XHsOuterExplicit a Specificity),
#endif
  XRecCond a )
...
reparenOuterTyVarBndrs :: forall flag a. (
  ...
  WDT (XRec a (HsType a)),
  WDT (Anno (HsType a)),
  WDT (Anno (HsTyVarBndr flag a)),
  WDT (XRec a (HsTyVarBndr flag a)),
  WDT (Anno [XRec a (HsType a)]),
  WDT (XRec a [XRec a (HsType a)]),
  WDT (Anno (HsTyVarBndr Specificity a)),
  WDT (XRec a (HsTyVarBndr Specificity a)),
